...
sites_from_drb_gis_website <- read.csv("gages.csv",colClasses = "character")
...
write.csv(available, "gages_with_sp_conductance.csv")


#used all the counties from the drb to query the WQP interface and get this csv of all stations in those counties
list_WQP <- read.csv("gages_drb_counties_wqp.csv", colClasses = "character")
...
#write out period of record to file
write.csv(availableWQP, "wqp_gages_with_sp_conductance.csv")
