...
soilm_data_15yrs <- readRDS("cache/nhru_soilm_15yrs_reshape.rds")
soilm_data_5yrs <- soilm_data_15yrs[Date >= max_date - 5*365]
rm(soilm_data_15yrs)

snwpk_data_15yrs <- readRDS("cache/nhru_snwpk_15yrs_reshape.rds")
snwpk_data_5yrs <- snwpk_data_15yrs[Date >= max_date - 5*365]
rm(snwpk_data_15yrs)

# 1 week data
soilm_data_1wk <- readRDS("cache/nhru_soilm_1wk_reshape.rds")
snwpk_data_1wk <- readRDS("cache/nhru_snwpk_1wk_reshape.rds")
...
saveRDS(totS_data_5yrs, "cache/totS_5yrs.rds")
saveRDS(totS_data_1wk, "cache/totS_1wk.rds")
