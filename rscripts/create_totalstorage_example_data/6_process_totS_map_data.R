...
totS_percentiles_1wk <- readRDS("cache/totS_percentiles_1wk.rds")
...
writeLines(map_data_json, "cache/totS_map_data.json")
saveRDS(map_data, "cache/totS_map_data.rds")
...
# 
# s3_push <- aws.s3::put_object(file = "cache/totS_map_data.json",
