...
# Then save the nhru_pkwater_equiv.csv file to the `WBEEP/cache/` folder. 
# The line below will be used as the file path unless sbtools method works.
snwpk_data_fn <- "WBEEP/cache/nhru_pkwater_equiv.csv"
...
saveRDS(snwpk_data_15yrs, "WBEEP/cache/nhru_snwpk_15yrs.rds")
saveRDS(snwpk_data_1wk, "WBEEP/cache/nhru_snwpk_1wk.rds")
