...
#totS_data_25yrs <- readRDS("WBEEP/cache/totS_25yrs.rds")
# Lindsay's comp could only handle merging 5 years of snowpack with 5 years of soil moisture.
totS_data_5yrs <- readRDS("WBEEP/cache/totS_5yrs.rds")
...
# Save quantiles
saveRDS(totS_quantiles_fix, "WBEEP/cache/nhru_5yr_totS_quantiles.rds")
