...
snwpk_data_15yrs <- readRDS("WBEEP/cache/nhru_snwpk_15yrs.rds")
...
snwpk_data_1wk <- readRDS("WBEEP/cache/nhru_snwpk_1wk.rds")
...
saveRDS(snwpk_data_15yrs_fix, "WBEEP/cache/nhru_snwpk_15yrs_reshape.rds")
saveRDS(snwpk_data_1wk_fix, "WBEEP/cache/nhru_snwpk_1wk_reshape.rds")
