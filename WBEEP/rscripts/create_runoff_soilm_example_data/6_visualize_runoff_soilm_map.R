...
map_data <- readRDS("WBEEP/cache/runoff_soilm_map_data.rds")
...
ggsave(conus_nosmoothing, filename = "WBEEP/img/conus_runoffsoilm.png", 
       height = 8, width = 11)
...
st_write(conus_data_sf_proj, "WBEEP/cache/co_example_data_shp/conus_tableau.shp")
...
ggsave(conus_smoothing, filename = "WBEEP/img/conus_runoffsoilm_smoothing.png", 
       height = 8, width = 11)

# Converting to JSON and saving
#conus_data_json <- jsonlite::toJSON(conus_data_sf)
#readr::write_lines(conus_data_json, "WBEEP/cache/runoff_soilm_map_data_spatial.json")
